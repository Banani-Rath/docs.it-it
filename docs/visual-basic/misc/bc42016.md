...
-   Se possibile, usare valori dello stesso tipo di dati in modo che [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] non debba eseguire alcuna conversione.  
