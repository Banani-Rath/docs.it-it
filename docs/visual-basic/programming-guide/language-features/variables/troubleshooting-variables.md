...
Questa pagina elenca alcuni problemi comuni che possono verificarsi quando si lavora con le variabili in [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
