...
3.  Non è necessario stabilire quale versione della routine chiamare.  In [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] il controllo viene passato alla versione che corrisponde all'elenco di argomenti.  
