...
In questa sezione viene descritto come convalidare stringhe in [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
...
## In questa sezione  
 ...
 Come determinare se una stringa possiede le caratteristiche di una password sicura.  
