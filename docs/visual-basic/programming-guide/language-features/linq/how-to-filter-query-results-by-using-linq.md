...
Language\-Integrated Query \(LINQ\) semplifica l'accesso a informazioni di database e l'esecuzione di query.  
 ...
 Nell'esempio riportato di seguito viene illustrato come creare una nuova applicazione che esegue query su un database SQL Server e filtra i risultati in funzione di un particolare valore utilizzando la clausola `Where`.  Per ulteriori informazioni, vedere [Where Clause](../../../../visual-basic/language-reference/queries/where-clause.md).  
