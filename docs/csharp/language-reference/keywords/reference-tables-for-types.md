---
title: "Tabelle di riferimento per i tipi (Riferimenti per C#) | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "linguaggio C#, tipi di dati"
  - "linguaggio C#, tabelle di riferimento dei tipi"
  - "tipi [C#], tabelle di riferimento"
...
Nelle tabelle di riferimento che seguono sono riepilogati i tipi di C\#:  
 ...
 [Tipi di valore](../../../csharp/language-reference/keywords/value-types-table.md)  
