...
Il server d'inoltro del tipo 'tipo' nell'assembly 'assembly' provoca un ciclo  
  
 Questo errore si verifica solo con metadati importati con formato non corretto.  Non può verificarsi solo con il codice sorgente C\#.  
  
## Esempio  
 Nell'esempio riportato di seguito viene generato l'errore CS0731.  Sono inclusi tre file:  
 ...
 Compilare innanzitutto i file IL come librerie, quindi compilare il codice cs facendo riferimento ai due file.  
