...
helpviewer_keywords: 
  - "conversioni [C#]"
  - "conversioni [C#], da stringa a int"
  - "conversione da stringhe a int [C#]"
  - "stringhe [C#], conversione a int"
...
È possibile convertire una [stringa](../../../csharp/language-reference/keywords/string.md) in un numero usando i metodi della classe <xref:System.Convert> o usando il metodo `TryParse` presente nei diversi tipi numerici \(int, long, float e così via\).  
...
## Vedere anche  
 ...
 [Utilità di formattazione in .NET Framework 4](http://code.msdn.microsoft.com/NET-Framework-4-Formatting-9c4dae8d)