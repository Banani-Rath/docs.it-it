---
title: "Istruzioni, espressioni e operatori (Guida per programmatori C#) | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
Il codice C\# di un'applicazione è costituito da istruzioni formate da parole chiave, espressioni e operatori.  In questa sezione sono riportate informazioni relative a questi elementi fondamentali di un programma in linguaggio C\#.  
...
-   [Procedura: utilizzare l'overload degli operatori per creare una classe di numeri complessi](../../../csharp/programming-guide/statements-expressions-operators/how-to-use-operator-overloading-to-create-a-complex-number-class.md)  
